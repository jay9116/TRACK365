	...
	<div style="width:1000px;">
		...
		<div id="border" style="width:1000px; height:550px;  float:left; ">
			<div id="borderright" style="width:800px; height:500px;  float:left; background-color:white; ">
				...
				<display:table id="data" name="sessionScope.list" requestURI="/viewlifeinsurance.action" pagesize="10" export="true">
				...
				<display:setProperty name="export.excel.filename" value="LifeInsuranceDetails.xls"/>
            	<display:setProperty name="export.pdf.filename" value="LifeInsuraceDetails.pdf"/>
