	...
	<div style="width:1000px;">
		...
		<div id="border" style="width:1000px;  float:left; background-color:red;">
			<div id="borderright" style="width:700px; height:500px;  float:left; background-color:white; ">
				...
				<s:form action="addsm" method="post">
				<table>
				<tr>
				<td><s:select name="StockExchange" label="Stock Exchange" list="{'BSE','NSE'}"></s:select>
				</td>
				</tr>
				<tr>
				<td><s:select list="bselist" label="Company Name"  name="CompanyName"    ></s:select>
				</td>
				</tr>
				<tr>
				<td><s:textfield name="CompanyCode" label="Company Code" ></s:textfield>
				</td>
				</tr>
				<tr>
				...
				<tr>
				<td><s:textfield name="Units" label=" Number Of Units"></s:textfield>
				</td>
				</tr>
				<tr>
				<td> <s:textfield name="UnitPrice" label="Unit Price"></s:textfield>
				</td>
				</tr>
				<tr>
				<td> <s:textarea name="Description" cols="7" rows="4" label="Description" ></s:textarea>
				</td>
				</tr>
				<tr>
