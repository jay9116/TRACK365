	...
	<div style="width:1000px;">
		...
		<div id="border" style="width:1000px;  float:left; background-color:red;">
			<div id="borderright" style="width:700px; height:500px;  float:left; background-color:white; ">
				...
				<display:table id="data" name="sessionScope.list" requestURI="/editlifeinsurance.action" pagesize="10" export="false">
				...
				<display:column value="Edit" href="editli" title="Edit Record" paramId="id" paramProperty="id"/>
