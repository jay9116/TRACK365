	...
	<div style="width:1000px;">
		...
		<div id="border" style="width:1000px; height:550px;  float:left; ">
			<div id="borderright" style="width:800px; height:500px;  float:left; background-color:white; ">
				...
				<display:table id="data" name="sessionScope.list1" requestURI="/viewmutualfund.action" pagesize="10" export="true">
				...
				<display:setProperty name="export.excel.filename" value="MutualFundDetails.xls"/>
            	<display:setProperty name="export.pdf.filename" value="MutualFundDetails.pdf"/>
			...
			<div style="width:199px; height:500px; background-color:white; float:right">
					...
					<ul style="list-style: none;">
							...
							<li><a href="editmutualfund">Edit Record</a>
